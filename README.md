# Project Background
This project presents a structured exploratory data analysis of an e-commerce transactional dataset. The objective was to systematically examine sales performance, customer behavior, operational efficiency, and revenue distribution in order to understand how the business is performing and where patterns exist within the data.                                                                                                            
...
The business generated 21.78M in total revenue from 17,000 orders placed by 5,000 customers, resulting in an average order value of 1.28K.From a scale perspective, this indicates steady purchasing behavior and consistent transaction size across the dataset. Revenue is not driven by unusually large orders but by sustained order activity.When examining geographic distribution, revenue is clearly concentrated in a few high-performing cities. The top-performing city generated 5.6M, which is significantly higher than the second-ranked city at 3.1M. This shows that a substantial portion of total revenue is coming from a limited number of core markets.
       Similarly, product category analysis shows uneven contribution, where select categories generate a larger share of revenue compared to others. This confirms that overall performance is being driven by specific high-performing segments rather than evenly distributed demand.In summary, the business operates at a solid revenue scale, but performance is concentrated geographically and categorically, indicating reliance on key markets and product groups.


Time Based And Seasonal Trends:
Revenue performance across time reveals noticeable fluctuations rather than steady growth.The most significant movement occurred in April, where revenue declined by 45% compared to the previous month. This represents the sharpest drop within the reporting period and suggests a temporary disruption or slowdown in demand.Following this decline, the business gradually recovered. In July, revenue increased by 14% month-over-month, signaling renewed growth momentum. The year closed strongly, with December recording a 12% increase, indicating improved performance toward year-end.
           This pattern suggests that revenue performance is influenced by seasonal or timing-related factors rather than consistent month-over-month growth. The mid-year slowdown followed by recovery implies variability in demand cycles, promotional timing, or market conditions.   Overall, the time-series analysis shows that while the business demonstrates resilience and the ability to recover from downturns, revenue performance is not yet stable across all months


Operational Performance And Customer Satisfaction
When we examine delivery performance alongside customer ratings, a clear pattern begins to emerge. The majority of orders are delivered within ten days, with 7,572 orders arriving within five days and another 6,787 delivered between six and ten days. Only 2,179 orders fall into the      slow delivery category of eleven days or more, meaning operationally, most transactions are fulfilled within a reasonable timeframe.   Customer satisfaction remains relatively stable across delivery speeds, but subtle differences are visible. Orders delivered within five days received an average rating of 3.90, while those delivered within six to ten days recorded a slightly higher 3.91. However, once delivery extends beyond ten days, the average rating drops to 3.86. While this decline may appear small numerically, it signals that prolonged delivery times do begin to impact customer perception.
       What this tells us is that the business is performing well operationally overall, but maintaining delivery within the fast-to-medium range is important for preserving customer satisfaction. Once delivery delays stretch past ten days, customer experience begins to weaken. The relationship isn’t extreme, but it is measurable and consistent.
Customer Retention Strength:
Looking at customer behavior over time, the data shows strong repeat engagement. Out of 5,000 total customers, 3,862 — representing 77.24% — are returning customers, while only 1,138 customers, or 22.76%, made a single purchase. This indicates that the majority of revenue is supported by customers who come back to purchase again, rather than relying entirely on new customer acquisition.
       The influence of discounts further reinforces this pattern. Customers who received discounts generated an average revenue per customer of 4,268.7, compared to 2,385.4 among customers who did not receive discounts. This is a significant difference and suggests that promotional strategies are not only driving purchases but are associated with higher overall customer value.   Taken together, the data suggests that the business has established a relatively strong retention base. Customers are returning, and incentive strategies appear to deepen spending behavior. Rather than struggling with churn, the business demonstrates solid customer loyalty, supported by promotional engagement and repeat purchasing patterns.
